...
### 6. Install the docs-deploy workflow

Copy `workflows/docs-deploy.yml` to your project's `.github/workflows/docs-deploy.yml`. Update the path filters to match your package directory.
